...
import {
  FieldMoveParticlesWithVelocity,
  FieldAccParticlesWithGravity,
} from "../../gamelib/Actors/FieldMover";
...
export function FieldGenRemMove<P extends IParticle, F extends IField<P>>(
  timeModifier: number,
  field: F,
  on: boolean,
