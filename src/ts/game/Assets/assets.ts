import {
  IImageElement,
  ImageElement,
} from "../../gamelib/Elements/ImageElement";
import {
  IAudioElement,
  AudioElement,
} from "../../gamelib/Elements/AudioElement";
...
export class Assets {
  ...
  // buttons
  public backButton: IImageElement = new ImageElement(
    "res/img/backButtonThumb.png",
  );
  public nextButton: IImageElement = new ImageElement(
    "res/img/nextButtonThumb.png",
  );
  public surprise: IImageElement = new ImageElement("res/img/surprise.png");

  // sounds
  // music
  public flyInspire: IAudioElement = new AudioElement(
    "res/sound/flyInspire.mp3",
    true,
  );
  public cinematic: IAudioElement = new AudioElement(
    "res/sound/cinematic.mp3",
    true,
  );
  public emotional: IAudioElement = new AudioElement(
    "res/sound/emotional.mp3",
    true,
  );
  // sound fx
  ...
  public aCtx: AudioContext = new (window.AudioContext ||
