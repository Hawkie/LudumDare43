...
export function CreateHelp(): IHelp {
  return {
    title: "Instructions",
    help1:
      "The balloon era is upon us and flight is an adventurous and risky sport.",
    help2:
      "Gain prestige by flying and landing as many passengers as far as you can.",
    help3: "Control the balloon's temperature to gain lift.",
    help4: "The higher you fly the faster the wind speed.",
    help5:
      "To gain more control, you can sacrifice passengers but this will affect your prestige.",
    help6: "",
    exit: false,
    fingerDown: false,
  };
...
export function CreateHelpControls(): IHelp {
  return {
    ...
    help2:
      "<Q>/Drag Up - Burner on. Increases the temperature inside the balloon.",
    help3: "<A>/Drag Down - Dump Air. Dump air to drop temperature.",
    help4:
      "<-, ->/Drag Left/Right. Use jets of sideways air to manoeuver left and right.",
...
export function CreateHintHelp(): IHelp {
  return {
    title: "Hints",
    help1:
      "Temp is everything! Find the temp to maintain height. ~90 temp for 8 passengers.",
    help2: "Landing: Descent < 10 and land on flat ground.",
    help3:
      "Landing: Hold left over a flat area to drop quickly into a flat landing area.",
...
export function InputHelp(state: IHelp, eState: IEventState): IHelp {
  ...
  return { ...state, exit: exit, fingerDown: eState.press };
}
