...
export function UpdateAnimator<T extends IAnimator>(
  timeModifier: number,
  animator: T,
  animationDuration: number,
  animationSequence: ReadonlyArray<number>,
): T {
  const time: number = AddElapsedTime(
    timeModifier,
...
export function UpdateSprite<T extends ISprite>(
  timeModifier: number,
  sprite: T,
  frame: number,
): T {
